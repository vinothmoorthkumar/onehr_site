...
@Component({
  selector: 'app-asg-transcript',
  templateUrl: './asg-transcript.component.html',
  styleUrls: ['./asg-transcript.component.scss']
})
export class AsgTransComponent implements OnInit {
